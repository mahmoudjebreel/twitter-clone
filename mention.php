 ...
 <main role="main">
    <section class="mainSectionContainer">
       ...
       <div class="tabsContainer">
           <?php echo $loadFromTweet->createTab("ALL",url_for("i/notification"),false); ?>
           <?php echo $loadFromTweet->createTab("Mention",url_for('notification/mention'),true); ?>
       </div>
       <section aria-label="Timeline:Your Notification Timeline" class="resultsContainer">
         <?php $loadFromMessage->mentionNotification($user_id); ?>
       </section>
