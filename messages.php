        ...
        <?php if(!isset($_GET['message'])): ?>
            <div class="no-msg-container">
                <div class="n-msg-wrapper">
                    ...
                    <a href="/Tweety/messages?q=composeNewMessage" class="n-msg msg-btn" role="button" data-focusable="true">New message</a>
                </div>
            </div>
...
<script>
    $(function(){
        ...
        function userLoad(){
            ...
            $.post("http://localhost/tweety/backend/ajax/msgFetch.php",{loadUserid:$uid,otheruserid:otheruserid},function(data){
                // alert(data);
        ...
        if(otherpersonid !="" && otherpersonid !=null){
            $.post("http://localhost/tweety/backend/ajax/msgFetch.php",{userid:$uid,otherpersonid:otherpersonid},function(data){
                // alert(data);
        ...
        $(document).on("click","#semdMsgBtn",function(){
            ...
            if(msgData !="" && msgData !=null){
                $.ajax({
                    url:"http://localhost/tweety/backend/ajax/message.php",
                    type:"POST",
                    data:{
