...
$pageTitle='Suggested Users for '.$profileData->firstName.' '.$profileData->lastName.'(@'.$profileData->username.') / Twitter';
?>
...
<?php require_once "backend/shared/nav_header.php"; ?>
 ...
 <section class="mainSectionContainer">
       ...
       <div class="tabsContainer">
           <?php echo $loadFromTweet->createTab("Followers",url_for($profileData->username.'/followers'),false); ?>
           <?php echo $loadFromTweet->createTab("Following",url_for($profileData->username.'/following'),false); ?>
           <?php echo $loadFromTweet->createTab("Suggested Users",url_for($profileData->username.'/suggested'),true); ?>
       </div>
       <section aria-label="Timeline:Following" class="resultsContainer">
