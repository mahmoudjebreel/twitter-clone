$(function(){
   $(".f-btn").click(function(){
       ...
       if($button.hasClass("follow-btn")){
        $.post("http://localhost/tweety/backend/ajax/follow.php",{follow:followID,userId:userId},function(data){
        ...
        $.post("http://localhost/tweety/backend/ajax/follow.php",{unfollow:followID,userId:userId},function(data){
