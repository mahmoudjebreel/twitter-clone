$(function(){
    ...
    $(document).on("click",".retweet,.retweeted",function(){
        ...
        if(isRetweeted){
            $.post("http://localhost/tweety/backend/ajax/retweet.php",{deretweet:$post_id,user_id:$user_id,tweetby:$tweetby},function(data){
            ...
            $.post("http://localhost/tweety/backend/ajax/retweet.php",{tweetId:$post_id,user_id:$user_id,postedby:$tweetby},function(data){
    ...
    $(document).on("click",".retweet-btn",function(){
        ...
        $.post("http://localhost/tweety/backend/ajax/retweet.php",{retweet:$post_id,user_id:$user_id,comment:retweetComment,tweetby:$tweetby},function(data){
    ...
    $(document).on("click",".retweet-btn",function(){
        ...
        $.post("http://localhost/tweety/backend/ajax/retweet.php",{fetchretweet:$post_id,user_id:$user_id},function(data){
            $(".retweet-modal-container").hide();
