...
<?php require_once "backend/shared/nav_header.php"; ?>
 <main role="main">
     <?php include_once "backend/shared/profile_header.php" ?>
       ...
       <section aria-label="Timeline:Your Reply Timeline" class="repliesPostsContainer">
        <?php $loadFromTweet->repliesTweets($profileId,$user_id); ?>
       </section>
