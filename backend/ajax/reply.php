     ...
     <div class="reply-modal-content">
           ...
           <div class="reply-modal-body">
               <div class="reply-container">
                   <div class="reply-wrapper-image">
                       <img src="<?php echo url_for($post->profileImage); ?>" alt="<?php  echo $post->firstName.' '.$post->lastName; ?>">
                   </div>
                  <div class="reply-content-wrapper">
                        <div class="reply-content-desc">
                            ...
                            <div class="reply-desc-date">
                                <span class="reply-date-time">.</span><?php  echo $loadFromUser->timeAgo($post->postedOn); ?>                          </div>
                        </div>
                        <div class="reply-desc-text">
                        <?php  echo $loadFromTweet->getTweetLinks($post->status); ?>            </div>
                        <div class="reply-to-desc">
                            <span class="reply-to">Reply to</span> <a href="<?php  echo url_for(h($post->username)); ?>" class="reply-username-link">@<?php  echo $post->username; ?></a>
                        </div>
                  </div>
               </div>
         ...
         <?php
           ...
           <div class="reply-modal-body">
               <div class="reply-container">
                   <div class="reply-wrapper-image">
                       <img src="<?php echo url_for($commentpost->profileImage); ?>" alt="<?php  echo $commentpost->firstName.' '.$commentpost->lastName; ?>">
                   </div>
                  <div class="reply-content-wrapper">
                        <div class="reply-content-desc">
                            <div class="reply-user-fullName">
                            ...
                            <div class="reply-desc-date">
                                <span class="reply-date-time">.</span><?php  echo $loadFromUser->timeAgo($commentpost->commentAt); ?>                          </div>
                        </div>
                        <div class="reply-desc-text">
                        <?php  echo $loadFromTweet->getTweetLinks($commentpost->comment); ?>            </div>
                        <div class="reply-to-desc">
                            <span class="reply-to">Reply to</span> <a href="<?php  echo url_for(h($commentpost->username)); ?>" class="reply-username-link">@<?php  echo $commentpost->username; ?></a>
                        </div>
                  </div>
               </div>
               <div class="reply-user-msg">
