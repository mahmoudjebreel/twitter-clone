                           ...
                           <div class="modal-retweet-content">
                               <div class="modal-retweet-header">
                                   <div class="modal-user-img-wrapper">
                                     <img src="<?php echo url_for($post->profileImage); ?>" alt="<?php  echo $post->firstName.' '.$post->lastName; ?>" width="30px">
                                   </div>
                     ...
                     <div class="modal-header">
                       ...
                       <div class="modal-body">
                           ...
                           <div class="modal-retweet-content">
                               <div class="modal-retweet-header">
                                   <div class="modal-user-img-wrapper">
                                     <img src="<?php echo url_for($commentpost->profileImage); ?>" alt="<?php  echo $commentpost->firstName.' '.$commentpost->lastName; ?>" width="30px">
                                   </div>
                                   <div class="retweet-user-fullName">
