$(function(){
    ...
    $(document).on("click",".replyModal,.commented",function(){
        ...
        if(isCommented){
            $.post("http://localhost/tweety/backend/ajax/reply.php",{delComment:$post_id,commentBy:$user_id,tweetBy:$tweetby},function(data){
            ...
            $.post("http://localhost/tweety/backend/ajax/reply.php",{tweetId:$post_id,user_id:$user_id,postedby:$tweetby},function(data){
    ...
    $(document).on("click","#replyBtn",function(){
        ...
        if(textValue !="" && textValue !=null){
            $.post("http://localhost/tweety/backend/ajax/reply.php",{comment:textValue,commentOn:$post_id,commentBy:$user_id,tweetBy:$tweetby},function(data){
                $(".reply-wrapper").hide();
